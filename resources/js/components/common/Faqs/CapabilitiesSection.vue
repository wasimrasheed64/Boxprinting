...
const capabilities = [
    ...
    { title: '3D Design Services', icon: '🖥️' },
    { title: 'Flexible Lead Times', icon: '🗓️' },
    { title: 'High-Volume Printing', icon: '🖨️' },
    { title: '24/7 Support', icon: '📞' },
    { title: 'Custom Payment Plans', icon: '🤝' },
    { title: 'Warehousing & Inventory', icon: '🏢' }
]
</script>
