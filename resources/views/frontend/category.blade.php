                    ...
                    <div class="pin-wrapper" style="height: 1328.64px;">
                        <div class="sticky-sidebar" data-sticky-options="{'top': 10}"
                            ...
                            <div class="widget widget-collapsible">
                                ...
                                <ul id="scroll_id" class="widget-body filter-items search-ul" style="height: 1000px; overflow: scroll">
            ...
            <h4 class="title title-sm title-line title-underline mt-5"><span>Request a Quote</span></h4>
                ...
                <div class="tab-pane text-dark bg-white border-qoute-form" id="tab6-3">
                    <div class="row p-5">
                        ...
                        <div class="col-lg-10" id="mainDescription"  style="height:800px; overflow-y: scroll;overflow-x:hidden">
