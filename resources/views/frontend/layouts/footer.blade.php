        ...
        <div class="banner-content row">
            <div class="col-lg-12">
                    <div class="text-center">
                        ...
                        <a href="{{ route('custom.quote') }}" class="btn btn-secondary border-radius-20">Request a Quote</a>
                    </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="widget">
                                ...
                                <ul class="widget-body">
                                    @foreach(Product::where('is_footer',1)->limit(9)->get() as $product)
                                        <li>
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="widget">
                                ...
                                <ul class="widget-body">
                                    @foreach(Category::where('is_footer',1)->limit(9)->get() as $category)
                                        <li>
