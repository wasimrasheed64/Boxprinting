<header class="header">
        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="{{ route('home') }}" class="logo d-none d-lg-block">
                    <img src="{{ $siteSetting->logo }}" alt="logo" width="" height=""/>
                </a>
                <!-- End Logo -->
            ...
            <div class="header-right">
                ...
                <a href="tel:#" class="icon-box icon-box-side">
                    <div class="icon-box-icon mr-0 mr-lg-2">
                        <i class="d-icon-mail"></i>
                    </div>
                    <div class="icon-box-content d-lg-show">
                        <h4 class="icon-box-title">Email us at:</h4>
                        <p>{{ $siteSetting->email }}</p>
                    </div>
                </a>
                <span class="divider"></span>
                <div class="faa-flash animated ">
                <img alt="chat" src="{{ asset('assets/images/chat.jpg')}}" width="50" height="50" class="chatlink pb-3 pl-2" onclick="openChat()">
</div>
    ...
    <div class="header-bottom d-lg-show sticky-header fix-top sticky-content padding-y-0">
        <div class="container">
            ...
            <div class="header-right">
            <a href="{{ route('custom.quote') }}" class="btn btn-secondary">Request a Qoute</a>
            </div>
        </div>
    </div>
</header>
